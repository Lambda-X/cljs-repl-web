(ns ^:figwheel-load cljs-bootstrap.core-test
  (:require [cljs.test :refer-macros [deftest is]]
            [cljs-bootstrap.core :as core :refer [get-prompt success? unwrap-result]]
            [cljs-bootstrap.repl :as repl]
            [cljs-bootstrap.common :as common :refer [valid-eval-result? valid-eval-error? extract-message]]))
...
(deftest prompt
  ...
  (is (re-find (re-pattern (str (repl/current-ns))) (get-prompt)) "core/get-prompt should contain the current namespace"))
